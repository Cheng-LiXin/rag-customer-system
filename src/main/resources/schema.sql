...
CREATE TABLE `message` (
    ...
    `feedback`        TINYINT  NOT NULL DEFAULT 0 COMMENT 'AI消息反馈：0-未评 1-有帮助 2-没帮助（数据飞轮入口）',
    `feedback_time`   DATETIME DEFAULT NULL COMMENT '反馈时间',
    `feedback_comment` VARCHAR(500) DEFAULT NULL COMMENT '点踩时可选填的原因',
    `create_time`     DATETIME DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
